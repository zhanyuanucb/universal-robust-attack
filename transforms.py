...
def get_random_gaussian_pt(device="cpu", max_sigma=0.1, mean=None, std=None):
...
def get_random_contrast_pt(device="cpu", min_alpha=0.9, max_alpha=1.4, mean=None, std=None):
    mean, std = mean.to(device), std.to(device)
...
def get_random_brightness_pt(device="cpu", min_beta=-0.05, max_beta=0.05, mean=None, std=None):
    mean, std = mean.to(device), std.to(device)
